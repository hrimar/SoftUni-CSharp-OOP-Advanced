namespace Forum.App.Factories
{
    ...
    public class TextAreaFactory : ITextAreaFactory
	{
		public ITextInputArea CreateTextArea(IForumReader reader, int x, int y, bool isPost = true)
		{
            ...
            //Type commandType = assembly.GetTypes().FirstOrDefault(t => typeof
            //         (ITextInputArea).IsAssignableFrom(t));
            ...
            //ITextInputArea commandInstance = (ITextInputArea)Activator.CreateInstance
            //             (commandType, args);
