namespace Forum.App.Menus
{
    ...
    public class ViewPostMenu : Menu, IIdHoldingMenu
    {
        ...
        private IForumViewEngine forumViewEngine;
        private ICommandFactory commandFactory;
        private IPostService postService;

        public ViewPostMenu(ILabelFactory labelFactory, ISession session, IForumViewEngine forumViewEngine,
		...
		public override IMenu ExecuteCommand()
		{
            ...
            IMenu nemu = command.Execute(this.postId.ToString());

            this.forumViewEngine.ResetBuffer();
